...
List<SeatLockBean> findByShowIdAndStatusAndLockedUntilAfter(Integer showId, String status, LocalDateTime now);
...
List<SeatLockBean> findByStatusAndLockedUntilBefore(String status, LocalDateTime time);
