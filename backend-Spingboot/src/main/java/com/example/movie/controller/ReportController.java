...
public class ReportController {
     ...
     * GET /api/reports/comprehensive?startDate=2025-11-01&endDate=2025-11-30&movieIds=1,2&screenIds=1&ticketTypes=adult,student
     * 
     * 回傳:
     ...
     * GET /api/reports/export/comprehensive?format=excel&startDate=2025-11-01&endDate=2025-11-30&movieIds=1,2
     * 
     ...
     */
    @SuppressWarnings("unchecked")
    private byte[] generateExcelReport(Map<String, Object> reportData, LocalDate startDate, LocalDate endDate) throws IOException {
